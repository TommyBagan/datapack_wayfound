# {slot: <string>, item_area: <string>}
# Exit early if there is no lodestone_tracker component
scoreboard players set @s wayfound.result 0
$execute store success score @s wayfound.result run data get entity @s $(slot).components."minecraft:lodestone_tracker"
...
scoreboard players set @s wayfound.result 0
$execute store success score @s wayfound.result run data get entity @s $(slot).components."minecraft:custom_data"."wayfound:target"
...
$execute store result score @s wayfound.target.original.x run data get entity @s $(slot).components."minecraft:lodestone_tracker".target.pos[0]
$execute store result score @s wayfound.target.original.y run data get entity @s $(slot).components."minecraft:lodestone_tracker".target.pos[1]
$execute store result score @s wayfound.target.original.z run data get entity @s $(slot).components."minecraft:lodestone_tracker".target.pos[2]

# Store the copied coordinates
$execute store result score @s wayfound.target.copy.x run data get entity @s $(slot).components."minecraft:custom_data"."wayfound:target".pos[0]
$execute store result score @s wayfound.target.copy.y run data get entity @s $(slot).components."minecraft:custom_data"."wayfound:target".pos[1]
$execute store result score @s wayfound.target.copy.z run data get entity @s $(slot).components."minecraft:custom_data"."wayfound:target".pos[2]
...
$data modify storage wayfound:temp local.copied_dimension set from entity @s $(slot).components."minecraft:lodestone_tracker".target.dimension
$execute store success score @s wayfound.result run data modify storage wayfound:temp local.copied_dimension set from entity @s $(slot).components."minecraft:custom_data"."wayfound:target"."dimension"
execute if score @s wayfound.result matches 0 run return 0
