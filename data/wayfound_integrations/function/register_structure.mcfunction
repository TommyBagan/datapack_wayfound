...
execute unless data storage wayfound:temp {local:{parameters:{version:0}}} run return run function wayfound:internal/report_error {error:"Unsupported version used."}

# Ensure each parameter isn't an empty string.
execute if data storage wayfound:temp {local:{parameters:{name:""}}} run return run function wayfound:internal/report_error {error:"Parameter 'name' is an empty string."}
execute if data storage wayfound:temp {local:{parameters:{namespace:""}}} run return run function wayfound:internal/report_error {error:"Parameter 'namespace' is an empty string."}
execute if data storage wayfound:temp {local:{parameters:{structure_id:""}}} run return run function wayfound:internal/report_error {error:"Parameter 'structure_id' is an empty string."}
execute if data storage wayfound:temp {local:{parameters:{type:""}}} run return run function wayfound:internal/report_error {error:"Parameter 'type' is an empty string."}
...
execute if data storage wayfound:temp {local:{result:0b}} run return run function wayfound:internal/report_error {error:"Parameter 'name' is not a string."}
...
execute if data storage wayfound:temp {local:{result:0b}} run return run function wayfound:internal/report_error {error:"Parameter 'namespace' is not a string."}
...
execute if data storage wayfound:temp {local:{result:0b}} run return run function wayfound:internal/report_error {error:"Parameter 'structure_id' is not a string."}
...
execute if data storage wayfound:temp {local:{result:0b}} run return run function wayfound:internal/report_error {error:"Parameter 'type' is not a string."}

# Ensures type is set to one of the options
data modify storage wayfound:temp local.result set value 0b
execute if data storage wayfound:temp {local:{parameters:{type:"dungeon"}}} run data modify storage wayfound:temp local.result set value 1
execute if data storage wayfound:temp {local:{parameters:{type:"trial"}}} run data modify storage wayfound:temp local.result set value 1
execute if data storage wayfound:temp {local:{parameters:{type:"settlement"}}} run data modify storage wayfound:temp local.result set value 1
execute if data storage wayfound:temp {local:{parameters:{type:"ruins"}}} run data modify storage wayfound:temp local.result set value 1
execute if data storage wayfound:temp {local:{result:0b}} run return run function wayfound:internal/report_error {error:"Parameter 'type' is not set to 'dungeon','trial','settlement' or 'ruins'."}

# Checks the structure is a valid namespace.
data modify storage wayfound:temp local.result set value 0b
$function wayfound:internal/check_if_structure_valid {id:"$(namespace):$(structure_id)"}
$execute if data storage wayfound:temp {local:{result:0b}} run return run function wayfound:internal/report_error {error:"Structure '$(namespace):$(structure_id)' is not a valid resource."}

# All looks good - so we appends the structure to the structure list!
$data modify storage wayfound:structures registry.list append value {id:"$(namespace):$(structure_id)",text:"structures.$(namespace).$(structure_id)",fallback:"$(name)",type:"$(type)"}
